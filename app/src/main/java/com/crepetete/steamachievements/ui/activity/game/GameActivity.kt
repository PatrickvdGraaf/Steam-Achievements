...
class GameActivity : DaggerAppCompatActivity() {
    ...
    private val achievementsOvetrTimeGraph by lazy { findViewById<GraphView>(R.id.graph) }
    ...
    private fun setAchievements(achievements: List<Achievement>) {
        ...
        val graphHelper = AchievementsGraphHelper()
        graphHelper.setAchievementsOverTime(achievementsOvetrTimeGraph, achievements)
    }
